...
var configs = []config{
	...
	{Typ: cfgBool, Name: "auth_cert", Usage: "启用客户端证书验证", ValBool: false},
	{Typ: cfgBool, Name: "auth_only_cert", Usage: "仅客户端证书验证", ValBool: false},
	...
	{Typ: cfgBool, Name: "send_otp", Usage: "是否发送OTP", ValBool: false},
	{Typ: cfgStr, Name: "send_otp_type", Usage: "发送OTP方式 [mail phone]", ValStr: "mail"},
	{Typ: cfgBool, Name: "encryption_password", Usage: "用户密码是否加密保存", ValBool: false},
	{Typ: cfgStr, Name: "weixin_work_verify_file_name", Usage: "企微验证文件名", ValStr: "WW_verify_8lm2edfBycwtHwwIN.txt"},
	{Typ: cfgStr, Name: "weixin_work_verify_file_content", Usage: "企微验证文件内容", ValStr: "8lmahgsdwcwtHwwIN"},
	{Typ: cfgBool, Name: "sync_ldap_users", Usage: "是否自动同步LDAP用户", ValBool: false},
