...
func StartAdmin() {
	...
	r.HandleFunc("/set/client_cert/unbind_device", UnbindDevice)
	r.HandleFunc("/set/client_cert/update_max_devices", UpdateClientCertMaxDevices)
	r.HandleFunc("/set/client_cert/update_device_binding", UpdateClientCertDeviceBinding)
