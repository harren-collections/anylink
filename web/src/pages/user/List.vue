<template>
  <div>
    <el-card>
      ...
      <el-pagination background layout="total, sizes, prev, pager, next, jumper" :pager-count="11"
        @size-change="handleSizeChange" @current-change="pageChange" :current-page="page"
        :page-sizes="[10, 20, 50, 100, 200, 500]" :page-size="pageSize" :total="count">
      </el-pagination>
    ...
    <el-dialog :close-on-click-modal="false" title="用户" :visible="user_edit_dialog" @close="disVisible" width="650px"
      ...
      <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="ruleForm">
        ...
        <el-form-item label="MTU" prop="mtu">
          <el-input-number v-model="ruleForm.mtu" :min="0" :max="1500"></el-input-number>
          <el-tooltip content="单独设置用户MTU，不填使用全局默认配置" placement="top">
